...
* в этой 8-й проектной работе я реализовал разбитие оставшегося кода в index.js на компоненты:
  - ```Section```
  - ```Popup```
  - ```PopupWithImage```
  - ```PopupWithForm```
...
Также установил node.js и все необходимые пакеты NPM, WebPack и плагины.  
